![breezy Development Discord]

<details>
    <summary><b>Important Links</b></summary>
        <p>
            <a href="https://discord.gg/KekrMtH5">
...
RegisterCommand('toggleseatbelt', function()
    ...
    TriggerServerEvent('breezy-harness:server:toggleBelt', plate)
end, false)
...
QBCore.Functions.CreateUseableItem("harness", function(source, item)
    TriggerClientEvent('breezy-harness:client:attachHarness', source, item)
end)
```
